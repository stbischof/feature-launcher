 ...
 * @since Sep 15, 2024
 */
class RemoteArtifactRepositoryImpl extends AbstractMavenArtifactRepositoryImpl {
	private static final Logger LOG = LoggerFactory.getLogger(RemoteArtifactRepositoryImpl.class);

	private final URI repositoryURI;
	private final RemoteRepository remoteRepository;

	public RemoteArtifactRepositoryImpl(URI repositoryURI, Path localPath, Map<String, Object> configurationProperties) {
