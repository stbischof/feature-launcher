 ...
 * @since Sep 17, 2024
 */
public class RemoteArtifactRepositoryImplTest extends RemoteArtifactRepositoryTest{

	@Override
	protected Class<? extends ArtifactRepository> getRemoteArtifactRepoImplType() {
		return RemoteArtifactRepositoryImpl.class;
	}
