...
public class AddExtensionFeatureDecorator implements FeatureDecorator {
	 ...
	 * 
	 * @see
	 * org.osgi.service.featurelauncher.decorator.FeatureDecorator#decorate(org.osgi
	 * .service.feature.Feature,
	 * org.osgi.service.featurelauncher.decorator.FeatureDecorator.
	 * FeatureDecoratorBuilder,
	...
	public Feature decorate(Feature feature, List<ArtifactRepository> repositories,
	        FeatureDecoratorBuilder decoratedFeatureBuilder, DecoratorBuilderFactory factory)
	        throws AbandonOperationException {
		return decoratedFeatureBuilder
		        .setClassifier(feature.getID().getClassifier().orElse(null)).setExtensions(List.of(factory
		                .newExtensionBuilder("testExtension", Type.TEXT, Kind.OPTIONAL).addText("foobar").build()))
		        .build();
	}
}