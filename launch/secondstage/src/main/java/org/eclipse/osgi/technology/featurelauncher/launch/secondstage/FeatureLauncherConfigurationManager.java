...
import static org.eclipse.osgi.technology.featurelauncher.common.osgi.util.impl.ConfigurationUtil.CONFIGURATION_DEFAULT_LOCATION;
import static org.eclipse.osgi.technology.featurelauncher.common.osgi.util.impl.ConfigurationUtil.normalizePid;
...
public class FeatureLauncherConfigurationManager implements ServiceTrackerCustomizer<Object, Object> {
	...
	private Map<String, Object> getConfigurationProperties(Object configurationObject)
		...
		Dictionary<String, Object> dictionary = (Dictionary<String, Object>) getConfigurationPropertiesMethod.invoke(configurationObject);
