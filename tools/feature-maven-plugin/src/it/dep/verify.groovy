...
assert json.id.contains("dependency")
...
def hasNamespaceService = bundleIds.any { it.contains("org.osgi.namespace.service") }
assert hasNamespaceService : "Expected bundle org.osgi.namespace.service not found in: ${bundleIds}"
